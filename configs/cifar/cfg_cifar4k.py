...
model = {'feat_extractor_z': 'cifar_cnn', 'emb_z_size': 192, 'emb_z_act': 'elu',
         'batch_norm_decay': 0.99, 'l2_reg_feat': 1e-8, 'l2_reg_classif': 1e-6, 'classifier_dropout': 0.5}

# --- Validation, labelled and unlabelled folds for training ---
dataset = 'cifar' # mnist, svhn, cifar
...
num_lbl_samples = 4000  # How many labelled data to learn from. -1 to use all.
...
# --- Training loop ---
max_iters = 75000 # Max training iterations. I think it overfits and 65k would be better, but whatever.
...
cc_weight = 0.1 # Weight w in: Ltotal = Lsup + w*Lcclp . Set to 0 to disable CCLP.
